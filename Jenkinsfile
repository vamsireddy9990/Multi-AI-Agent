pipeline {
    ...
    stages {
        ...
        stage('Cloning GitHub Repository') {
            steps {
                script {
                    ...
                    // Using modern checkout syntax instead of scmGit
                    checkout([
                        $class: 'GitSCM',
                        branches: [[name: '*/main']],
                        extensions: [],
                        userRemoteConfigs: [[
                            ...
                            credentialsId: 'github-token' // ✅ make sure this credential ID exists
                        ]]
                    ])
                }
            }
        ...
        // // SonarQube Analysis (Commented out — not used currently)
